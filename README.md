...
<h2>Overview</h2>
<div class="section">
  <p>This mod endeavors to add a psionics system to the BG games which uses completely new  mechanics.  It is experimental, doing things that the game engine was not really designed for.  But in play it should give you a new king od character with new kinds of abilities.  I have no idea how it is balanced, power-wise, against the game's traditional warrior and magic-using classes... let's find out! :)</p>
</div>
<h2>Installation</h2>
<div class="section">
...
<div class="section">
  ...
  <p><strong>Install Order:</strong><br />
    Honestly I'm not really sure yet.  With other thief kit mods - say, after Rogue Rebalancing but before Might & Guile.</p>
</div>
<h2>Component 100: </h2>
  <div class="section">
    ...
    <p><strong><em>The WtP Psionic Powers</em></strong></p>
	  <ul>
	    ...
	    <li> <b>Telekinesis - Project Force:</b> this ability blasts a target with powerful but unfocused telekinetic energy, causing 2d3 stunning damage and, upon a failed saving throw, knocking the target back 5 feet. Additionally, this ability has a 50% chance to break open locks. At 6th level the damage is 2d4 and the save is rolled with a -1 penalty; at 12th level the damage is 2d6 and the save is rolled with a -2 penalty. The cost is 4 hit points.</li>
	    <li> <b>Telekinesis - Immobilize:</b> the target of this power is held frozen in place, unable to move or act, upon a failed saving throw. On the second round and each round thereafter, up to ten rounds, an immobilized target may attempt another save to escape the effect. Even if a save is made, the target is very briefly Slowed while fighting off the telekinetic control. At levels 6 and 12, the target's saving throw is rolled with a -1 and -2 penalty, respectively. The cost is 6 hit points.</li>
	    <li> <b>Telekinesis - Inertial Barrier:</b> this ability creates a movable barrier inches from the psion's skin, which has several protective effects: it provides a +2 bonus to AC and 40% damage resistance against crushing and missile attacks; a +1 AC bonus and 20% damage resistance against slashing attacks; 25% resistance to fire, acid, and magic damage; and immunity to the Magic Missile spell. The cost to maintain the Barrier is 6 hit points.</li>
	    <li> <b>Telekinesis - Psychic Knife:</b> the psion can focus telekinetic energy into a razor-sharp blade emanating from <PRO_HISHER> hand. This force can be wielded like a sword, as if the rogue had Mastery (+++) in its use, doing 1d4 slashing damage and 1d4 magic damage.  At 12th level, the blade is wielded as if with Grandmastery. The cost to maintain the Psychic Knife is 6 hit points.</li>
	    <li> <b>Telekinesis - Repulsion:</b> this ability creates an unfocused surge of telekinetic force which throws anyone nearby away from the psion (except allies, who can be shielded from the effect), unless they make a saving throw vs. Breath. While the ability is maintained, this surge of force builds and is released once per 3 seconds. The cost to maintain the repulsion effect is 9 hit points.</li>
	    <li> <b>Telekinesis - Free Action:</b> this ability allows the psion to break free of any bonds; and to avoid being caught or held by any effect that affects <PRO_HISHER> mobility. Such spells or events will fail to affect the psion as long as this ability is maintained. The cost to maintain free Action is 9 hit points.</li>
	    <li> <b>Telekinesis - Mass Immobilize:</b> all enemies within 20' of the psion are held frozen in place, unable to move or act, upon a failed saving throw. On the second round and each round thereafter, up to ten rounds, each immobilized target may attempt another save to escape the effect. Even if a save is made, the target is very briefly Slowed while fighting off the telekinetic control. At levels 6 and 12, the target's saving throw is rolled with a -1 and -2 penalty, respectively. The cost is 9 hit points.</li><br />
	    <li> <b>Pyrokinesis - Static Discharge:</b> this ability is similar to the Shocking Grasp wizard spell. The psion collects static electricity in his hand, and then uses it to attack an enemy. The enemy takes 2d4+1 points of damage, and must make a saving throw or be stunned for 1 round. At 6th level the damage is 3d4+2 and the save is rolled with a -1 penalty; at 12th level the damage is 4d4+3 and the save penalty increases to -2. The cost is 4 hit points.</li>
	    <li> <b>Pyrokinesis - Molecular Agitation:</b> this ability causes the molecules on the edge of the psion's weapon to to become so excited that they can ignite material with which they make contact. The functional result is that all successful melee attacks made by the psion do 1d6 points of heat damage in addition to the normal weapon damage. The cost to maintain the ability is 6 hit points.</li>
	    <li> <b>Pyrokinesis - Energy Dispersion:</b> while this ability is maintained, the psion instinctively absorbs and deflects harmful energies. <PRO_HISHER> resistance to energy-based damage (fire, cold, electricity, and magic damage) is set to 60%. The cost to maintain the barrier is 6 hit points.</li>
	    <li> <b>Pyrokinesis - Psychic Combustion:</b> this ability allows the psion to spontaneously create a brief but powerful fire in any location. The flames do 3d4+3 fire damage to all enemies within 5 feet of the point of combustion. At 6th level the damage increases to 4d4+4, and at 12th level the damage increases to 5d4+5. The cost is 6 hit points.</li>
	    <li> <b>Pyrokinesis - Solar Flash:</b> this ability creates an intense ray of radiant energy in a 20-ft. radius around the psion. All enemies within the area of effect take 2d4 points of heat damage and must save vs. petrification with a -1 penalty or be blinded for 4 rounds.  At 12th level the saving throw penalty increases to -2, and at 18th level it increases to -3. Undead that are hit by the solar flare take double damage. The cost is 9 hit points.</li>
	    <li> <b>Pyrokinesis - Freezing Precipitation:</b> this ability removes heat energy from an area at a prodigious rate.  Snow and ice will precipitate out of the air and beings in the area of effect will suffer 2d4 points of damage per round from the cold, for four rounds. Additionally, beings in the area of effect must make a saving throw vs. Breath Weapon each round they remain in the area or have their movement rate halved for that round. The cost is 9 hit points.</li>
	    <li> <b>Pyrokinesis - Generate Lightning:</b> after taking a few moments to collect static energy from the surrounding area, the rogue can discharge it as violent lightning energy. The lightning strikes a chosen target and arcs to any other enemies within 10 feet (the psion has some measure of control over the energy and can protect <PRO_HISHER> companions). The discharge does 2d6 lightning damage, which is halved upon a successful saving throw. At 6th level the damage is 3d6 and the save is rolled with a -1 penalty. At 12th level the damage is 4d6 and the save is rolled with a -2 penalty. The cost is 9 hit points.</li><br />
	    <li> <b>Biokinesis - Adrenaline Rush:</b> this ability causes the rogue's physical stats to increase by 1-3 for 4 rounds, followed bythis ability temporarily boosts the psion's strength by 2 points and increasing <PRO_HISHER> movement and attack speed, for 3 rounds. Afterward, the psion becomes tired and weakened (-4 to STR) for 2 rounds. At 6th level the Strength bonus is increased to +3 and lasts 4 rounds; and at 12th level it is increased to +4 and lasts 5 rounds. The cost is 4 hit points, and the ability may not be used again until the weakness has worn off.</li>
	    <li> <b>Biokinesis - Body Purification:</b> This ability removes all toxins from the body, both natural and magical in nature. It immediately neutralizes any poison and will also cure any diseases that the psion might be suffering from, as well as blindness and deafness. The cost is 6 hit points.</li>
	    <li> <b>Biokinesis - Bioregeneration:</b> this ability triggers powerful healing responses in the psion's immune system, resulting in the regeneration of 1 hit point per round. This is a maintainable power; the psion can all such healing to fully take its course; however, the psion must concentrate on the power, and may not engage in physical combat while the power is maintained. At 6th level the psion regenerates 3 hit points every 2 rounds, and at 12th level the psion regenerates 3 hit points per round. The cost to maintain the regeneration is 6 hit points.</li>
	    <li> <b>Biokinesis - Chemical Simulation:</b> this ability allows the psion to secrete a toxic liquid and direct it at a nearby enemy. This attack does 2d3 poison damage, plus 1 point per round for 5 rounds (the initial damage is halved and the ongoing damage is avoided if the target makes a save vs. Poison.  At 6th level the damage increases to 2d4, +2/round; and at 12th level it increases to 2d6, +3/round. The cost is 6 hit points.</li>
	    <li> <b>Biokinesis - Absorb Infliction:</b> this ability allow the psion to sacrifice his own bodily health in order to heal an ally. If the psion's current hit points are greater than the ally's, then the difference between the two values will be subtracted form the psion and added to the ally. Additionally, the ally may be cured of inflictions such as poison, disease, blindness and deafness. The psion takes on such ailments, and immediately performs a Body Purification, purging them from <PRO_HISHER> own body. The cost is 9 hit points, and the strain of such healing increases the psion's level of fatigue.</li>
	    <li> <b>Biokinesis - Camouflage:</b> this ability makes the psion's body blend into the nearby environment like a chameleon. The effect is similar to the Improved Invisibility spell, although it does not actually involve invisibility: the psion has a -4 bonus to AC, a +40% bonus to stealth, and cannot easily be targeted by spellcasters. The cost to maintain the Camouflage is 9 hit points.</li>
	    <li> <b>Biokinesis - Carapace:</b> this ability causes the rogue's skin to harden into a fast-regenerating, strong but brittle shell. This provides a -2 bonus to AC, and harmlessly absorbs 1 physical attack each round. The cost to maintain the Carapace is is 9 hit points.</li><br />
	    <li> <b>Clairsentience - Object Reading:</b> once per day, out of combat, the psion may determine the history and nature of am item or weapon.</li>
	    <li> <b>Clairsentience - Insightful Strike:</b> while maintained, the next attack made by the psion will automatically be a critical hit. The cost to maintain this ability is is 6 hit points.</li>
	    <li> <b>Clairsentience - Instinctive Luck:</b> while this ability is maintained, the psion's foresight and intuition give <PRO_HIMHER> 1-point bonus to Luck, which results in a 5% bonus to to-hit rolls, saving throws, rogue skills, and melee damage, as well as a 10% bonus to skill checks. The cost to maintain this ability is 6 hit points.</li>
	    <li> <b>Clairsentience - Sensory Dissociation:</b> upon activate this ability, the psion is able to view a distant area.  After using the ability, click on a section of the map that you want to view. For five rounds, the psion can spy on that area, noting creatures and fortifications. The cost is 6 hit points.</li>
	    <li> <b>Clairsentience - Life Detection:</b> this ability allows the psion to detect intelligent thought around them. This makes invisible creatures visible to and targetable by the psion, but not by anyone else (unless they have their own means of seeing through invisibility). Note, this *does* function against undead, golems, and similar constructs; even those animated beings have rudimentary cognition sufficient to impart motor control - and it is that cognitive process which can be detected. The cost to maintain this ability is 9 hit points.</li>
	    <li> <b>Clairsentience - Danger Sense:</b> while this ability is maintained, the psion has a 3-point bonus to Armor Class, a 25% bonus to the Find Traps skill, and cannot be backstabbed. Further, if the psion encounters certain magical and environmental effects that can be dodged, <PRO_HESHE> may attempt a saving throw vs. Breath Weapon to avoid the effect altogether. The cost to maintain this ability is is 9 hit points.</li>
	    <li> <b>Clairsentience - Precognition:</b> this ability gives the psion a vague glimpse into dangers and challenges that <PRO_HESHE> and <PRO_HISHER> allies may face in the immediate future. The Psion and all allies within range of easy communication can benefit from this information, receiving a 1-point/10% bonus to thac0, AC, saving throws, and skill checks for the next two turns. The cost is 9 hit points.</li><br />
	  </ul>
  </div>
<h2>Component 200: </h2>
  <div class="section">
    ...
    <div class="kit_description">
      <p>PSIONICIST: the Psionicist is someone who (mostly) turns away from larcenous pursuits, and focuses on education and meditation to fully harness the power of the mind and the body. Psionicists are generally very well-educated and very healthy, treating their body as a temple. Through study and discipline, they can learn to use psychic abilities from any psionic discipline.</p>
      <p>Abilities:<br />
        &ndash; Begins with access to the first power in all five psionic disciplines: Mind Thrust, Project Force, Static Discharge, Adrenaline Rush, and Object Reading. The Psionicist can proceed to learn an additional power with each new level of experience, from any psionic discipline.<br />
        &ndash; May learn an additional psionic ability every level-up.<br />
        &ndash; Gains one extra hit point on every even level, up to level 20.</p>
      <p>Restrictions:<br />
...
<h2>Component 300: </h2>
  <div class="section">
    <p><strong><em>Add the SOULBLADE (warrior kit)</em></strong></p>
    <div class="kit_description">
      <p>SOULBLADE: this warrior uses meditation to harness psychic powers in order to enhance <PRO_HISHER> martial abilities. Often training with Psionicists or Psyphers, the Soulblade splits <PRO_HISHER> time and effort between improving <PRO_HISHER> martial prowess and mastering new psionic abilities.</p>
      <p>Abilities:<br />
        &ndash; Begins with access to the first power in all five psionic disciplines: Mind Thrust, Project Force, Static Discharge, Adrenaline Rush, and Object Reading. The Soulblade can proceed to learn an additional power at every odd level of experience, from any psionic discipline.<br />
        &ndash; May learn an additional psionic ability every other level-up.</p>
      <p>Restrictions:<br />
        &ndash; Gains hit dice as a priest (d8) instead of a warrior.<br />
        &ndash; Limited to medium armors.<br />
        &ndash; Limited to Mastery (+++) with melee weapons.<br />
        &ndash; Limited to Proficiency (+) with ranged weapons.<br />
        &ndash; May not be Chaotic.<br />.</p>
    </div>
  </div>
  <div class="section">
<h2>Component 400: </h2>
    <p><strong><em>Add the PSYPHER (monk kit)</em></strong></p>
    <div class="kit_description">
      <p>PSYPHER: the Psypher is ... yadda yadda ...  Through study and discipline, they can learn to use psychic abilities from any psionic discipline.</p>
      <p>Abilities:<br />
        &ndash; Begins with access to the first power in all five psionic disciplines: Mind Thrust, Project Force, Static Discharge, Adrenaline Rush, and Object Reading. The Psionicist can proceed to learn an additional power with each new level of experience, from any psionic discipline.<br />
        &ndash; May learn an additional psionic ability every level-up.</p>
      <p>Restrictions:<br />
        &ndash; Does not become resistant to magic.<br />
        &ndash; Cannot Lay On Hands or use any other traditional Monk abilities.<br />
        &ndash; May not be Chaotic.<br />.</p>
    </div>
  </div>
...
<div class="section">
  <p>Huge thanks in particular to kjeron, Camdawg, Mike1072, kreso, Grammarsalad, Aquadrizzt, and more for advice and help with the code. And to everyone participating in the Dev thread at forum.beamdog.com, for helping to sort through my good and bad ideas and helping me get the best ones implemented. </p>
