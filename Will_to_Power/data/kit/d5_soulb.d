...
IF ~Global("D5_FEAT","GLOBAL",1)~ THEN BEGIN d5_soulb
 ...
 IF ~GlobalLT("D5_PSI_103","LOCALS",1)~ THEN REPLY @1031 GOTO d5_soulb_103		//	id insinuation
 IF ~GlobalLT("D5_PSI_104","LOCALS",1)~ THEN REPLY @1041 GOTO d5_soulb_104		//	mind ward
 IF ~GlobalLT("D5_PSI_105","LOCALS",1)~ THEN REPLY @1051 GOTO d5_soulb_105		//	ego repair
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",2) GlobalLT("D5_PSI_107","LOCALS",1)~ THEN REPLY @1071 GOTO d5_soulb_107	//	domination
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",2) GlobalLT("D5_PSI_108","LOCALS",1)~ THEN REPLY @1081 GOTO d5_soulb_108	//	intellect fortress
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",2) GlobalLT("D5_PSI_109","LOCALS",1)~ THEN REPLY @1091 GOTO d5_soulb_109	//	psychic crush
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",5) GlobalLT("D5_PSI_111","LOCALS",1) CheckStatGT(myself,13,LEVEL)~ THEN REPLY @1111 GOTO d5_soulb_111	//	tower of iron will
 IF ~GlobalLT("D5_PSI_203","LOCALS",1)~ THEN REPLY @2031 GOTO d5_soulb_203		//	immobilize
 IF ~GlobalLT("D5_PSI_204","LOCALS",1)~ THEN REPLY @2041 GOTO d5_soulb_204		//	inertial barrier
 IF ~GlobalLT("D5_PSI_205","LOCALS",1)~ THEN REPLY @2051 GOTO d5_soulb_205		//	psychic knife
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",2) GlobalLT("D5_PSI_207","LOCALS",1)~ THEN REPLY @2071 GOTO d5_soulb_207	//	repulsion
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",2) GlobalLT("D5_PSI_208","LOCALS",1)~ THEN REPLY @2081 GOTO d5_soulb_208	//	free action
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",2) GlobalLT("D5_PSI_209","LOCALS",1)~ THEN REPLY @2091 GOTO d5_soulb_209	//	mass immobilize
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",5) GlobalLT("D5_PSI_211","LOCALS",1) CheckStatGT(myself,13,LEVEL)~ THEN REPLY @2111 GOTO d5_soulb_211	//	earthquake
 IF ~GlobalLT("D5_PSI_303","LOCALS",1)~ THEN REPLY @3031 GOTO d5_soulb_303		//	molecular agitation
 IF ~GlobalLT("D5_PSI_304","LOCALS",1)~ THEN REPLY @3041 GOTO d5_soulb_304		//	energy dispersion
 IF ~GlobalLT("D5_PSI_305","LOCALS",1)~ THEN REPLY @3051 GOTO d5_soulb_305		//	psychic combustion
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",2) GlobalLT("D5_PSI_307","LOCALS",1)~ THEN REPLY @3071 GOTO d5_soulb_307	//	solar flash
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",2) GlobalLT("D5_PSI_308","LOCALS",1)~ THEN REPLY @3081 GOTO d5_soulb_308	//	freezing precipitation
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",2) GlobalLT("D5_PSI_309","LOCALS",1)~ THEN REPLY @3091 GOTO d5_soulb_309	//	generate lightning
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",5) GlobalLT("D5_PSI_311","LOCALS",1) CheckStatGT(myself,13,LEVEL)~ THEN REPLY @3111 GOTO d5_soulb_311	//	energy storm
 IF ~GlobalLT("D5_PSI_403","LOCALS",1)~ THEN REPLY @4031 GOTO d5_soulb_403		//	body purification
 IF ~GlobalLT("D5_PSI_404","LOCALS",1)~ THEN REPLY @4041 GOTO d5_soulb_404		//	bioregeneration
 IF ~GlobalLT("D5_PSI_405","LOCALS",1)~ THEN REPLY @4051 GOTO d5_soulb_405		//	chemical simulation
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",2) GlobalLT("D5_PSI_407","LOCALS",1)~ THEN REPLY @4071 GOTO d5_soulb_407	//	absorb infliction
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",2) GlobalLT("D5_PSI_408","LOCALS",1)~ THEN REPLY @4081 GOTO d5_soulb_408	//	camouflage
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",2) GlobalLT("D5_PSI_409","LOCALS",1)~ THEN REPLY @4091 GOTO d5_soulb_409	//	carapace
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",5) GlobalLT("D5_PSI_411","LOCALS",1) CheckStatGT(myself,13,LEVEL)~ THEN REPLY @4111 GOTO d5_soulb_411	//	bestial transformation
 IF ~GlobalLT("D5_PSI_503","LOCALS",1)~ THEN REPLY @5031 GOTO d5_soulb_503		//	insightful strike
 IF ~GlobalLT("D5_PSI_504","LOCALS",1)~ THEN REPLY @5041 GOTO d5_soulb_504		//	precognitive luck
 IF ~GlobalLT("D5_PSI_505","LOCALS",1)~ THEN REPLY @5051 GOTO d5_soulb_505		//	clairvoyant sight
 IF ~GlobalGT("D5_CLAIRSENTIENCE","LOCALS",2) GlobalLT("D5_PSI_507","LOCALS",1)~ THEN REPLY @5071 GOTO d5_soulb_507	//	contingent eventuality
 IF ~GlobalGT("D5_CLAIRSENTIENCE","LOCALS",2) GlobalLT("D5_PSI_508","LOCALS",1)~ THEN REPLY @5081 GOTO d5_soulb_508	//	life detection
 IF ~GlobalGT("D5_CLAIRSENTIENCE","LOCALS",2) GlobalLT("D5_PSI_509","LOCALS",1)~ THEN REPLY @5091 GOTO d5_soulb_509	//	danger sense
 IF ~GlobalGT("D5_CLAIRSENTIENCE","LOCALS",5) GlobalLT("D5_PSI_511","LOCALS",1) CheckStatGT(myself,13,LEVEL)~ THEN REPLY @5111 GOTO d5_soulb_511	//	clairvoyant channeling
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",5) GlobalGT("D5_TELEKINESIS","LOCALS",5) GlobalLT("D5_PSI_901","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9011 GOTO d5_soulb_901	//	ultrablast
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",5) GlobalGT("D5_PYROKINESIS","LOCALS",5) GlobalLT("D5_PSI_902","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9021 GOTO d5_soulb_902	//	energy construct
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",5) GlobalGT("D5_BIOKINESIS","LOCALS",5) GlobalLT("D5_PSI_903","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9031 GOTO d5_soulb_903	//	fission
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",5) GlobalGT("D5_PYROKINESIS","LOCALS",5) GlobalLT("D5_PSI_904","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9041 GOTO d5_soulb_904	//	atomic disruption
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",5) GlobalGT("D5_BIOKINESIS","LOCALS",5) GlobalLT("D5_PSI_905","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9051 GOTO d5_soulb_905	//	exoskeleton
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",5) GlobalGT("D5_BIOKINESIS","LOCALS",5) GlobalLT("D5_PSI_906","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9061 GOTO d5_soulb_906	//	elemental composition
 IF ~GlobalGT("D5_TELEPATHY","LOCALS",5) GlobalGT("D5_CLAIRSENTIENCE","LOCALS",5) GlobalLT("D5_PSI_907","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9071 GOTO d5_soulb_907	//	project mind
 IF ~GlobalGT("D5_TELEKINESIS","LOCALS",5) GlobalGT("D5_CLAIRSENTIENCE","LOCALS",5) GlobalLT("D5_PSI_908","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9081 GOTO d5_soulb_908	//	dimensional anchor
 IF ~GlobalGT("D5_PYROKINESIS","LOCALS",5) GlobalGT("D5_CLAIRSENTIENCE","LOCALS",5) GlobalLT("D5_PSI_909","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9091 GOTO d5_soulb_909	//	stasis field
 IF ~GlobalGT("D5_BIOKINESIS","LOCALS",5) GlobalGT("D5_CLAIRSENTIENCE","LOCALS",5) GlobalLT("D5_PSI_910","LOCALS",1) CheckStatGT(myself,14,LEVEL)~ THEN REPLY @9101 GOTO d5_soulb_910	//	body control
END

IF ~~ THEN BEGIN d5_soulb_103 // id insinuation
 SAY @1032
...
END
IF ~~ THEN BEGIN d5_soulb_104 //  mind ward
 SAY @1042
 ...
 IF ~~ THEN REPLY @97 GOTO d5_soulb 
END
IF ~~ THEN BEGIN d5_soulb_105 // ego repair
 SAY @1052
 ...
 IF ~~ THEN REPLY @97 GOTO d5_soulb 
END
IF ~~ THEN BEGIN d5_soulb_107 // domination
 SAY @1072
 ...
 IF ~~ THEN REPLY @97 GOTO d5_soulb 
END
IF ~~ THEN BEGIN d5_soulb_108 // intellect fortress
 SAY @1082
 ...
 IF ~~ THEN REPLY @97 GOTO d5_soulb 
END
IF ~~ THEN BEGIN d5_soulb_109 // psychic crush
 SAY @1092
 ...
 IF ~~ THEN REPLY @97 GOTO d5_soulb 
END
IF ~~ THEN BEGIN d5_soulb_111 // tower of iron will
 SAY @1112
