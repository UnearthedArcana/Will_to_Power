  ...
  <div class="section">
    ...
    <p><b>Telepathy</b><p/>
	  <ul>
	    ...
	    <li> <b>Mass Hysteria:</b> this ability induces frenzied madness in all nearby enemies, causing them to become confused for three rounds if each one fails a saving throw. At 6th level the confusion lasts 5 rounds, and at 12th level the confusion lasts 7 rounds. The cost is 10 points.</li><br />
    ...
    <p><b>Biokinesis</b><p/>
	  <ul>
	    ...
	    <li> <b>Dermal Carapace:</b> this ability causes the psion's skin to harden into a fast-regenerating, strong but brittle shell. This provides a -2 bonus to AC, and harmlessly absorbs 1 physical attack each round. The cost to maintain the Carapace is 10 points.</li>
